...
/*FUNCIONAL CON EL MODAL EN EVENT QUE DICE HOLA
...
const CreateProjectForm = () => {
  ...
  useEffect(() => {
    ...
    if (tempEvent) {
      ...
      setValue("event", parsedEvent); // para que quede reflejado en el form
      localStorage.removeItem("temporaryProjectEvent");
    } else {
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <EventSelectorModal
                  onSelect={(event) => {
                    setSelectedEvent(event);
                    setValue("event", event); // ← guarda el objeto evento en el form
                    setValue("event_id", event.id); // ← guarda el ID del evento también
                    setShowEventModal(false);
                  }}
                />
              </div>
