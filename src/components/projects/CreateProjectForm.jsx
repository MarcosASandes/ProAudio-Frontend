        ...
        <div className="mb-3">
          ...
          >
            {productFields.map((field, index) => {
              const currentProductId = watch(`products.${index}.product_id`);
                ...
                >
                  ...
                  <div className="mb-2">
                    ...
                    >
                      ...
                      <option value="1">Precio A - $100</option>
                      <option value="2">Precio B - $150</option>
                    </select>
                  </div>
            ...
            <button
              ...
              onClick={() =>
                appendProduct({ product_id: "", price_id: "", amount: "" })
              }
            >
              Agregar producto
            </button>
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-2">
                    ...
                    >
                      {getValues(`products.${index}.product_label`) ||
                        "Seleccionar producto"}
                    </button>
                    <input
                      type="hidden"
        ...
        <div className="mb-3">
          ...
          >
            ...
            {/*{productFields.map((field, index) => {
              ...
              // Usamos el hook para cargar precios del producto actual
              useGetPricesByProductId(currentProductId);

              const productPrices = useSelector((state) =>
                selectProductPrices(state, currentProductId)
              );
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-2">
                    ...
                    <select
                      className="form-select"
                      disabled={!currentProductId || productPrices.length === 0}
                      {...register(`products.${index}.price_id`)}
                    >
                      <option value="">Seleccionar precio</option>
                      {productPrices.map((price) => (
                        <option key={rent_price_id} value={rent_price_id}>
