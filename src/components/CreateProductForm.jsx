...
export default function CreateProductForm() {
  ...
  // Mostrar modal de selección de etiqueta
  const showModal = () => {
  ...
  return (
    <div className="controlled-overflow-container">
      <div className="mb-3">
        <button
          type="button"
      ...
      >
        ...
        <div className="mb-3">
          <button
            className="btn btn-outline-info w-100 text-start collapse-style-colors"
            type="button"
          ...
          <div className="collapse mt-2" id="collapsePrices">
        ...
        <div className="mb-3">
          ...
          <div className="collapse mt-2" id="collapsePhotos">
            {photoFields.map((field, index) => (
              ...
              >
                <div className="mb-2">
                  <label className="form-label text-light">URL</label>
                  <input
                    type="text"
                    className="form-control"
            ...
            <button
              ...
              onClick={() => {
                if (photoFields.length < 10) appendPhoto({ url: "", name: "" });
              }}
            >
              Agregar foto
            </button>
        ...
        <div className="mb-3">
          ...
          <div className="collapse mt-2" id="collapseTags">
...
/*ORIGINAL FUNCIONA PERO SIN FOTO */
/*import { useForm, useFieldArray } from "react-hook-form";
import { yupResolver } from "@hookform/resolvers/yup";
import { productSchema } from "../validators/productValidator";
import { ToastContainer, toast } from "react-toastify";
  ...
  return (
    <div className="controlled-overflow-container">
      ...
      >
        ...
        <div className="mb-3">
          <button
            className="custom-collapse-btn w-100 text-start collapse-style-colors"
            type="button"
            data-bs-toggle="collapse"
            data-bs-target="#collapsePrices"
            aria-expanded="false"
          ...
          <div
            className="collapse custom-collapse-body mt-2"
            id="collapsePrices"
          >
            {priceFields.map((field, index) => {
            ...
            <button
              ...
              onClick={() =>
                appendPrice({
                  value: "",
                  description: "",
                  editMode: true, // siempre editable al crear
                })
              }
            >
              Agregar precio
              ...
              >
                <div className="mb-3">
                  ...
                  <input
                    type="file"
                    accept="image/*"
                    multiple //Para seleccionar muchas imgs
                    className="form-control bg-dark text-light border-secondary"
                    onChange={(e) =>
...
/*Implementación con múltiples fotos */
