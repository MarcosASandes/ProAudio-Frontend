...
const useGetItemsByProduct = (productId, page, size, status) => {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      ...
      try {
        const data = await getAllItemsByProduct(productId, page, size, status);
  ...
  }, [dispatch, productId, page, size, status]);
};
